...
public class URControllerByteReceiverFunction extends ThreadFunction {
    private final String urControllersAddress;
    private final int urControllersPort;

    private Socket socket;

    public URControllerByteReceiverFunction(String urControllersAddressParam, int urControllersPortParam) {
