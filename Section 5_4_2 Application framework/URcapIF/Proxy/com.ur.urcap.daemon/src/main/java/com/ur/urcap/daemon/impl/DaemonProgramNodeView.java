...
public class DaemonProgramNodeView implements SwingProgramNodeView<DaemonProgramNodeContribution> {
	...
	public DaemonProgramNodeView(Style style) {
		this.style = style;
	}

	@Override
	public void buildUI(JPanel panel, ContributionProvider<DaemonProgramNodeContribution> provider) {
	...
	private Box createInput(final ContributionProvider<DaemonProgramNodeContribution> provider) {
